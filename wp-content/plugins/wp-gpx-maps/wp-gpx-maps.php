...
add_action('wp_enqueue_scripts', 'register_WP_GPX_Maps_scripts');
...
function register_WP_GPX_Maps_scripts() {

    wp_register_script('googlemaps', '//maps.googleapis.com/maps/api/js');
    wp_register_script('highcharts', "//code.highcharts.com/3.0.10/highcharts.js", array('jquery'), "3.0.10");
...
// Folgende Zeilen hinzugefügt
    ...
    if (!($skipcache == true)) {
        ...
        @file_put_contents($gpxcache, serialize(array("points_maps" => $points_maps,
    ...
    $output = '
		<div id="wpgpxmaps_' . $r . '" class="wpgpxmaps">
			<div id="map_' . $r . '_cont" style="width:' . $w . '; height:' . $mh . ';position:relative" class="gpx_map">
				<div id="map_' . $r . '" style="width:' . $w . '; height:' . $mh . '" class="gpx_map"></div>
