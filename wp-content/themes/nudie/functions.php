...
if ( class_exists('WooCommerce') ) {
	require_once( trailingslashit( get_template_directory() ) . 'woocommerce/woocommerce-core.php' );
}

if ( class_exists('bbPress') ) {
	require_once( trailingslashit( get_template_directory() ) . 'bbpress/bbpress-core.php' );
}

/* Do theme setup on the 'after_setup_theme' hook. */
add_action( 'after_setup_theme', 'nudie_theme_setup' );

/**
 * Theme setup function.  This function adds support for theme features and defines the default theme
 * actions and filters.
 */
function nudie_theme_setup() {
 ...
 */
function nudie_remove_recent_comments_style() {
...
add_action( 'widgets_init', 'nudie_remove_recent_comments_style' );
 ...
 * Add/remove scripts
 */
function nudie_add_remove_scripts(){
	...
	wp_enqueue_style( 'nudie', get_template_directory_uri() . '/style.css' , array('opensans'), $parent['Version'] ); 
	...
	wp_enqueue_script( 'bootstrap', THEME_URI . '/js/bootstrap.min.js','jquery','3.3.6',true);

	/* nudie JS */
	wp_enqueue_script( 'nudie', THEME_URI . '/js/nudie.js','jquery',$parent['Version'],true);
	
}

add_action( 'wp_enqueue_scripts', 'nudie_add_remove_scripts' );
