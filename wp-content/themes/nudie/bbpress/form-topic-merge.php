...
<div id="bbpress-forums">
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge">
			...
			<form id="merge_topic" name="merge_topic" method="post" action="<?php the_permalink(); ?>" role="form">
				...
				<fieldset>
					...
					<div>
						...
						<legend><?php _e( 'Topic Extras', 'bbpress' ); ?></legend>
							...
							<div class="checkbox">
								<label for="bbp_topic_subscribers"><input name="bbp_topic_subscribers" id="bbp_topic_subscribers" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Merge topic subscribers', 'bbpress' ); ?></label>
							</div>
							<?php endif; ?>

							<div class="checkbox">
								<label for="bbp_topic_favoriters"><input name="bbp_topic_favoriters" id="bbp_topic_favoriters" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Merge topic favoriters', 'bbpress' ); ?></label>
							</div>

							<?php if ( bbp_allow_topic_tags() ) : ?>
							<div class="checkbox">
								<label for="bbp_topic_tags"><input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Merge topic tags', 'bbpress' ); ?></label>
							</div>
							<?php endif; ?>
