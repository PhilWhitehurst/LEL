...
?>
	...
	<div class="col-sm-3">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class="vcard bbp-user-profile-link <?php if ( bbp_is_single_user_profile() ) :?>active<?php endif; ?>">
			...
			<li class="bbp-user-topics-created-link <?php if ( bbp_is_single_user_topics() ) :?>active<?php endif; ?>">
			...
			<li class="bbp-user-replies-created-link <?php if ( bbp_is_single_user_replies() ) :?>active<?php endif; ?>">
			...
			<li class="bbp-user-favorites-link <?php if ( bbp_is_favorites() ) :?>active<?php endif; ?>">
			...
			<li class="bbp-user-subscriptions-link <?php if ( bbp_is_subscriptions() ) :?>active<?php endif; ?>">
			...
			<?php endif; ?>
			<li class="bbp-user-edit-link <?php if ( bbp_is_single_user_edit() ) :?>active<?php endif; ?>">
