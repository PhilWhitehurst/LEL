			...
			<form id="split_topic" name="split_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="text" id="bbp_topic_split_destination_title" class="form-control" value="<?php printf( __( 'Split: %s', 'bbpress' ), bbp_get_topic_title() ); ?>" tabindex="<?php bbp_tab_index(); ?>" size="35" name="bbp_topic_split_destination_title" />
					</div>
				...
				<fieldset>
					...
					<div class="checkbox">
						<label for="bbp_topic_subscribers"><input name="bbp_topic_subscribers" id="bbp_topic_subscribers" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Copy subscribers to the new topic', 'bbpress' ); ?></label>
					</div>
					<?php endif; ?>

					<div class="checkbox">
						<label for="bbp_topic_favoriters"><input name="bbp_topic_favoriters" id="bbp_topic_favoriters" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Copy favoriters to the new topic', 'bbpress' ); ?></label>
					</div>

					<?php if ( bbp_allow_topic_tags() ) : ?>
					<div class="checkbox">
						<label for="bbp_topic_tags"><input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Copy topic tags to the new topic', 'bbpress' ); ?></label>
					</div>
					<?php endif; ?>
				...
				<div class="form-group">
					<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="btn btn-default"><?php _e( 'Submit', 'bbpress' ); ?></button>
				</div>
