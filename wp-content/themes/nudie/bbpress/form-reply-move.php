...
<div id="bbpress-forums">
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move">
			...
			<form id="move_reply" name="move_reply" method="post" action="<?php the_permalink(); ?>" role="form">
					...
					<div>
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<input type="text" id="bbp_reply_move_destination_title" class="form-control" value="<?php printf( __( 'Moved: %s', 'bbpress' ), bbp_get_reply_title() ); ?>" tabindex="<?php bbp_tab_index(); ?>" size="35" name="bbp_reply_move_destination_title" />
							</div>
						...
						<div class="form-group">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit" name="bbp_move_reply_submit" class="btn btn-default"><?php _e( 'Submit', 'bbpress' ); ?></button>
						</div>
					</div>
