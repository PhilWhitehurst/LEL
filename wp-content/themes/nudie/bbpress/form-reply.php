		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>" role="form">
			...
			<fieldset>
				...
				<div>
					...
					<?php bbp_the_content( array( 'context' => 'reply', 'editor_class' => 'bbp-the-content form-control' ) ); ?>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_reply_edit() ) : ?>
						...
						<div class="checkbox">
							<label for="bbp_log_reply_edit"><input name="bbp_log_reply_edit" id="bbp_log_reply_edit" type="checkbox" value="1" <?php bbp_form_reply_log_edit(); ?> tabindex="<?php bbp_tab_index(); ?>" /> <?php _e( 'Keep a log of this edit:', 'bbpress' ); ?></label>
						</div>
