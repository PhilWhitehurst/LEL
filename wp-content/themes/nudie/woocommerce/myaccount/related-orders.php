...
<table class="shop_table shop_table_responsive my_account_orders table table-striped">
				...
				<td class="order-actions">
					...
					if ( $actions ) {
						...
						foreach ( $actions as $key => $action ) {
							echo wp_kses_post( '<a href="' . esc_url( $action['url'] ) . '" class="button btn btn-default ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>' );
						}
						echo '</div>';
					}
					?>
