...
<div class="page-header">
	<h2 class="entry-title"><?php echo apply_filters( 'woocommerce_my_account_payment_methods_title', __( 'Payment Methods', 'woocommerce' ) ); ?></h2>
</div>

<?php if ( $has_methods ) : ?>

	<table class="woocommerce-MyAccount-paymentMethods shop_table shop_table_responsive account-payment-methods-table table table-striped">
		<thead>
			<tr>
