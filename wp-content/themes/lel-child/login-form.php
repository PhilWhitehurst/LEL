...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
    <?php $template->the_action_template_message('login', '<div class="alert alert-warning">', '</div>'); ?>
    ...
    <div class="col-md-6 col-sm-12">
        <form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url('login', 'login_post'); ?>" method="post" >
            ...
            <div class="form-group">
                <input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" class="btn btn-primary" value="<?php esc_attr_e('Log In', 'theme-my-login'); ?>" />
