        ...
        <header class="menu-container navbar navbar-fixed-top navbar-default" <?php hybrid_attr('header'); ?>>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    <div class="lel-header-logo pull-left">
                        <a href="<?php echo esc_url(home_url('/')); ?>" >
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logos/svg/<?php _e('LEL2017_Logo_White-EN_GB-RGB.svg', 'LEL2017'); ?>" class="center-block" >
                        </a>
                    </div>
